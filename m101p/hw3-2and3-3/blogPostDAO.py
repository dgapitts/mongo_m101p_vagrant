...
class BlogPostDAO:
    ...
    def get_posts(self, num_posts):
        ...
        print "in get posts 1" 
        print "key = " + str(num_posts)
    ...
    def get_post_by_permalink(self, permalink):
        ...
        print "in get_post_by_permalink 1"
        query = {}
        query['permalink']=permalink
        post = self.posts.find(query)
        print "get_post_by_permalink post :" + str(post)
        print "permalink key to find : " + permalink
        print query
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            selector = {}
            selector['permalink']=permalink

            print 'about to add comment, selector : ' + str(selector)
            print 'about to add comment, comment : ' + str(comment)


            self.posts.update(selector,{'$push':{'comments':comment}})
